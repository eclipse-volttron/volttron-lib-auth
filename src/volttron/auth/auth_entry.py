...
from volttron.auth.auth_utils import isregex
...
class AuthEntry(object):
    ...
    :param list rpc_method_authorizations: Authorized
        capabilities for this agent's rpc_subsys methods
    ...
    def build_rpc_authorizations_field(value):
        """Returns auth entry's rpc_subsys method authorizations value if valid."""
        if not value:
            return None
    ...
    def _get_rpc_method_authorizations(value):
        """Returns auth entry's rpc_subsys method authorizations value if valid."""
        err_message = ("Invalid rpc_subsys method authorization value: {} "
                       "of type {}. Authorized rpc_subsys method entries can "
